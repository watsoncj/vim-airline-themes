...
let s:gui_green = '#005f87' " modified to match angr
let s:cterm_green = 150
let s:gui_blue = '#87afd7' " blue for insert mode
let s:cterm_blue = 110
let s:gui_purple = '#afafd7'
let s:cterm_purple = 146
"let s:gui_orange = '#ffdfaf' " light brown
"let s:gui_orange = '#fdaf8a' " light brown
"let s:cterm_orange = 222
let s:gui_orange = '#ffaf87'
let s:cterm_orange = 216
let s:gui_red = '#d78787' " light red
let s:cterm_red = 174
let s:gui_pink = '#d7afd7' " light purple/pink
